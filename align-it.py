...
#------------------------------------------------------------------------------#
	...
	def runAlignIt(self):
		...
		#run Pharao
		os.system("align-it -d /tmp/_tmp_AlignIt.sdf -p /tmp/_tmp_AlignIt.phar")
		#os.system("/usr/local/src/align-it -d /tmp/_tmp_AlignIt.sdf -p /tmp/_tmp_AlignIt.phar")
...
#------------------------------------------------------------------------------#
	...
	def readAlignIt(self):
		...
		file = ttkinter.filedialog.askopenfile(parent=self.parent,
                                    mode='r',
